...
namespace BtnSqd {
	struct Vertices {
		...
		float vertexWeights[MAX_BONES_PER_VERTEX] = { 0.0f };
		int boneCount = 0;
	};
	...
	static uint32_t GetShaderDataSize(ShaderDataType type) {
		...
		case ShaderDataType::FloatArray: return sizeof(float) * MAX_BONES_PER_VERTEX;

		case ShaderDataType::Int: return sizeof(int);
		case ShaderDataType::Int2: return sizeof(int) * 2;
		case ShaderDataType::Int3: return sizeof(int) * 3;
		case ShaderDataType::Int4: return sizeof(int) * 4;
		case ShaderDataType::IntArray:return sizeof(int) * MAX_BONES_PER_VERTEX;
