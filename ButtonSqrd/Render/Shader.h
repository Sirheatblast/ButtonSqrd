...
namespace BtnSqd {
	...
	public:
		...
		virtual void SetFloatArray(const std::string& name, std::vector<float> value) const = 0;
		virtual void SetMat4Array(const std::string& name, std::vector<glm::mat4> value)const =0;
